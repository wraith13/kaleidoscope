...
define("script/screenshot", ["require", "exports", "script/controller/index"], function (require, exports, _controller_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Screenshot) {
        ...
        Screenshot.shuffleAnimation = function () {
            _controller_1.Controller.Animation.shuffleAnimation();
        };
...
define("script/events", ["require", "exports", "script/library/index", "script/features/index", "script/controller/index", "script/ui", "script/loadstatus", "script/url", "script/screenshot", "resource/config", "resource/control", "resource/loadstatus"], function (require, exports, _library_9, _features_4, _controller_2, ui_8, loadstatus_1, url_1, screenshot_1, config_json_9, control_json_3, loadstatus_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Events) {
        var update = function (setter) {
            ...
            if (!_controller_2.Controller.Animation.isInAnimation()) {
                _controller_2.Controller.Animation.animator.update();
            }
        };
        var updateDiagonalSize = function () {
            return update(function () { return _controller_2.Controller.Animation.animator.updateDiagonalSize(); });
        };
        var updateColorspace = function () {
            update(function () { return _controller_2.Controller.Animation.animator.setColorspace(ui_8.UI.colorspaceSelect.get()); });
        ...
        var updateColoring = function () {
            return update(function () { return _controller_2.Controller.Animation.animator.setColoring(ui_8.UI.coloringSelect.get()); });
        };
        var updatePattern = function () {
            return update(function () { return _controller_2.Controller.Animation.animator.setPattern(ui_8.UI.patternSelect.get()); });
        };
        var updateLayers = function () {
            update(function () { return _controller_2.Controller.Animation.animator.setLayers(parseInt(ui_8.UI.layersSelect.get())); });
        ...
        var updateSpotsLayers = function () {
            update(function () { return _controller_2.Controller.Animation.animator.setSpotsLayers(parseInt(ui_8.UI.spotslayersSelect.get()) / 100.0); });
        ...
        var updateCycleSpan = function () {
            return update(function () { return _controller_2.Controller.Animation.animator.setCycleSpan(parseInt(ui_8.UI.cycleSpanSelect.get())); });
        };
        ...
        var updateEasing = function () {
            return update(function () { return _controller_2.Controller.Animation.animator.setEasing(ui_8.UI.easingCheckbox.get()); });
        };
        ...
        Events.initialize = function () {
            ...
            ui_8.UI.playButton.data.click = function (event, button) {
                ...
                button.dom.blur();
                _controller_2.Controller.toggleAnimation();
            };
            ui_8.UI.runBenchmarkButton.data.click = function (event, button) {
                event === null || event === void 0 ? void 0 : event.stopPropagation();
                button.dom.blur();
                _controller_2.Controller.Benchmark.runBenchmark();
            };
            ...
            ui_8.UI.benchmarkAbortButton.data.click = function (event, button) {
                event === null || event === void 0 ? void 0 : event.stopPropagation();
                button.dom.blur();
                _controller_2.Controller.Benchmark.stopBenchmark();
            };
            ...
            _library_9.Library.Shortcuts.setCommandMap({
                ...
                "toggleAnimation": function () { return _controller_2.Controller.toggleAnimation(); },
                ...
                "toggleFullScreen": function () {
                    ...
                    if (_controller_2.Controller.Animation.isInAnimation()) {
                        _controller_2.Controller.Base.updateFullscreenState();
                    }
                },
                ...
                "unknownKeyDown": function () {
                    if (!_controller_2.Controller.Benchmark.isInBenchmarkOrResult()) {
            ...
            document.addEventListener("visibilitychange", function () {
                ...
                _controller_2.Controller.Benchmark.abortBenchmark();
            ...
            updateShowFpsLoadStatus();
            updateClock();
            screenshot_1.Screenshot.initialize(params);
        };
