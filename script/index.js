...
define("script/controller/animation", ["require", "exports", "script/features/index", "script/controller/base", "script/ui", "resource/config"], function (require, exports, _features_2, base_1, ui_3, config_json_5) {
    ...
    (function (Animation) {
        ...
        Animation.updateDiagonalSize = function () {
            return Animation.update(function () { return Animation.animator.updateDiagonalSize(); });
        };
        Animation.updateColorspace = function () {
            return Animation.update(function () { return Animation.animator.setColorspace(ui_3.UI.colorspaceSelect.get()); });
        };
        Animation.updateColoring = function () {
            return Animation.update(function () { return Animation.animator.setColoring(ui_3.UI.coloringSelect.get()); });
        };
        Animation.updatePattern = function () {
            return Animation.update(function () { return Animation.animator.setPattern(ui_3.UI.patternSelect.get()); });
        };
        Animation.updateLayers = function () {
            return Animation.update(function () { return Animation.animator.setLayers(parseInt(ui_3.UI.layersSelect.get())); });
        };
        ...
        Animation.updateCycleSpan = function () {
            return Animation.update(function () { return Animation.animator.setCycleSpan(parseInt(ui_3.UI.cycleSpanSelect.get())); });
        };
        Animation.updateFuseFps = function () {
            return _features_2.Features.Fps.fuseFps = parseFloat(ui_3.UI.fuseFpsSelect.get());
        };
        Animation.updateEasing = function () {
            return Animation.update(function () { return Animation.animator.setEasing(ui_3.UI.easingCheckbox.get()); });
        };
        Animation.updateShowFps = function () {
            return ui_3.UI.fpsDisplay.classList.toggle("hide", !ui_3.UI.showFps.get());
        };
...
define("script/events", ["require", "exports", "script/library/index", "script/controller/index", "script/ui", "resource/config"], function (require, exports, _library_6, _controller_1, ui_5, config_json_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Events) {
        Events.initialize = function () {
            ...
            ui_5.UI.colorspaceSelect.setChange(_controller_1.Controller.Animation.updateColorspace);
            ui_5.UI.coloringSelect.setChange(_controller_1.Controller.Animation.updateColoring);
            ui_5.UI.patternSelect.setChange(_controller_1.Controller.Animation.updatePattern);
            ui_5.UI.canvasSizeSelect.setChange(_controller_1.Controller.Animation.updateCanvasSize);
            ui_5.UI.layersSelect.setChange(_controller_1.Controller.Animation.updateLayers);
            ui_5.UI.cycleSpanSelect.setChange(_controller_1.Controller.Animation.updateCycleSpan);
            ui_5.UI.fuseFpsSelect.setChange(_controller_1.Controller.Animation.updateFuseFps);
            ...
            ui_5.UI.showFps.setChange(_controller_1.Controller.Animation.updateShowFps);
            ...
            _library_6.Library.Shortcuts.setCommandMap({
                ...
                "toggleShowFps": function () {
                    ...
                    _controller_1.Controller.Animation.updateShowFps();
                },
            ...
            window.addEventListener("resize", function () { return _controller_1.Controller.Animation.updateDiagonalSize(); });
        };
    })(Events || (exports.Events = Events = {}));
});
define("script/index", ["require", "exports", "script/library/index", "script/tools/index", "script/controller/index", "script/ui", "script/events"], function (require, exports, _library_7, _tools_3, _controller_2, ui_6, events_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    events_1.Events.initialize();
    ui_6.UI.initialize();
    _controller_2.Controller.Animation.initialize();
