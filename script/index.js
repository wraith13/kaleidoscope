...
define("locale/generated/master", ["require", "exports"], function (require, exports) {
    ...
    exports.localeMaster = {
        "ar": {
            ...
            "benchmark-description-display-score": "درجة العرض هي قيمة درجة دقة الشاشة مضروبة في معدل الإطارات تحت الحمل المنخفض (مع اعتبار 60 كـ 1).",
        ...
        "de": {
            ...
            "benchmark-description-display-score": "Die Anzeige-Punktzahl ist der Wert, der sich ergibt, wenn die Bildschirmauflösungspunktzahl mit der Framerate bei niedriger Last (wobei 60 als 1 gilt) multipliziert wird.",
        ...
        "el": {
            ...
            "benchmark-description-display-score": "Η βαθμολογία οθόνης είναι η τιμή που προκύπτει πολλαπλασιάζοντας τη βαθμολογία ανάλυσης οθόνης με το FPS χαμηλού φορτίου (με το 60 ως 1).",
        ...
        "es": {
            ...
            "benchmark-description-display-score": "La puntuación de pantalla es el valor obtenido multiplicando la puntuación de resolución de pantalla por la frecuencia de cuadro en baja carga (con 60 como 1).",
        ...
        "fa": {
            ...
            "benchmark-description-display-score": "امتیاز نمایش حاصل ضرب امتیاز وضوح صفحه و نرخ فریم بار کم است (عدد ۶۰ معادل ۱ در نظر گرفته می‌شود).",
        ...
        "fr": {
            ...
            "benchmark-description-display-score": "Le score d'affichage est la valeur obtenue en multipliant le score de résolution d'écran par le FPS en faible charge (60 équivaut à 1).",
        ...
        "hi": {
            ...
            "benchmark-description-display-score": "डिस्प्ले स्कोर स्क्रीन रेज़ोल्यूशन स्कोर और कम लोड फ्रेम दर (60 को 1 मानते हुए) को गुणा करके प्राप्त होता है।",
        ...
        "id": {
            ...
            "benchmark-description-display-score": "Skor tampilan adalah nilai yang diperoleh dengan mengalikan skor resolusi layar dengan frame rate beban rendah (dengan 60 sebagai 1).",
        ...
        "it": {
            ...
            "benchmark-description-display-score": "Il punteggio display è il valore ottenuto moltiplicando il punteggio di risoluzione schermo per il frame rate a basso carico (con 60 come 1).",
        ...
        "ja": {
            ...
            "benchmark-description-display-score": "ディスプレイスコアは画面解像度スコアと低負荷時フレームレート( 60 を 1 とします )を掛け合わせた値です。",
        ...
        "ko": {
            ...
            "benchmark-description-display-score": "디스플레이 점수는 화면 해상도 점수와 저부하 프레임레이트(60을 1로 계산)를 곱한 값입니다.",
        ...
        "nl": {
            ...
            "benchmark-description-display-score": "De displayscore is de waarde verkregen door de schermresolutiescore te vermenigvuldigen met de framerate bij lage belasting (waarbij 60 gelijk is aan 1).",
        ...
        "pl": {
            ...
            "benchmark-description-display-score": "Wynik wyświetlania to wartość uzyskana przez pomnożenie wyniku rozdzielczości ekranu przez FPS przy niskim obciążeniu (przyjmując 60 jako 1).",
        ...
        "pt": {
            ...
            "benchmark-description-display-score": "A pontuação de exibição é o valor obtido multiplicando a pontuação de resolução da tela pela taxa de quadros em baixa carga (com 60 como 1).",
        ...
        "ru": {
            ...
            "benchmark-description-display-score": "Баллы дисплея — это баллы разрешения экрана, умноженные на FPS при низкой нагрузке (60 принимается за 1).",
        ...
        "th": {
            ...
            "benchmark-description-display-score": "คะแนนการแสดงผลคือค่าที่ได้จากการคูณคะแนนความละเอียดหน้าจอกับอัตราเฟรมขณะโหลดต่ำ (โดย 60 เท่ากับ 1)",
        ...
        "tr": {
            ...
            "benchmark-description-display-score": "Ekran puanı, ekran çözünürlüğü puanı ile düşük yük FPS'nin (60 = 1 olarak alınır) çarpılmasıyla elde edilir.",
        ...
        "vi": {
            ...
            "benchmark-description-display-score": "Điểm hiển thị là giá trị lấy điểm độ phân giải màn hình nhân với tốc độ khung hình tải thấp (với 60 là 1).",
        ...
        "zh-cn": {
            ...
            "benchmark-description-display-score": "显示分数为屏幕分辨率分数与低负载时帧率（以 60 为 1）相乘得到的值。",
        ...
        "zh-tw": {
            ...
            "benchmark-description-display-score": "顯示分數為螢幕解析度分數乘以低負載時幀率（以 60 為 1）。",
...
define("script/ui", ["require", "exports", "script/tools/index", "script/library/index", "resource/config", "resource/control", "resource/powered-by"], function (require, exports, _tools_3, _library_3, config_json_4, control_json_2, powered_by_json_1) {
    ...
    (function (UI) {
        ...
        UI.updateLanguage = function () {
            ...
            var lang = _library_3.Library.Locale.getLocale();
            document.documentElement.setAttribute("lang", lang);
            document.documentElement.setAttribute("dir", _library_3.Library.Locale.getDirection(lang));
